...
const paymentMidtrans = async (req, res) => {
    try {
        ...
        const parameter = {
            transaction_details: {
                order_id: appointment._id.toString(),
...
export { registerUser, loginUser, getProfile, updateProfile, bookAppointment, listAppointment, cancelAppointment, paymentMidtrans, midtransWebhook }